...
//    char test_packet[4] = {0};
    ...
    if (result == 0x7) {
        ...
        dmp_set_accel_bias(accel);
				stm_printf("setting bias succesfully ......\n");
    }
	else
	{
		stm_printf("bias has not been modified ......\n");
	}
}
...
#define log_e    stm_printf
#define log_i    stm_printf
...
#define memcmp(src, dst, len)		MemCmp((const char *)src, (const char *)dst, len)
